...
class ApiService {
  ...
  static Future<List<CodigoGrabovoi>> getCodigos({
    ...
    print('🔍 [API] ===========================================');
    print('🔍 [API] INICIANDO DIAGNÓSTICO COMPLETO');
    print('🔍 [API] ===========================================');
    print('🔍 [API] Parámetros: categoria=$categoria, search=$search');
    print('🔍 [API] Timestamp: ${DateTime.now()}');
    print('🔍 [API] Platform: ${Platform.operatingSystem}');
    print('🔍 [API] ===========================================');
    
    // ESTRATEGIA 1: Intentar con dominio personalizado (más compatible)
    try {
      print('🌐 [ESTRATEGIA 1] ===========================================');
      print('🌐 [ESTRATEGIA 1] PROBANDO DOMINIO PERSONALIZADO');
      print('🌐 [ESTRATEGIA 1] ===========================================');
      print('🌐 [ESTRATEGIA 1] Timestamp: ${DateTime.now()}');
      print('🌐 [ESTRATEGIA 1] Llamando CustomDomainService.getCodigos()...');
      ...
      print('✅ [ESTRATEGIA 1] ÉXITO - Dominio personalizado funcionó');
      print('✅ [ESTRATEGIA 1] Códigos obtenidos: ${result.length}');
      print('✅ [ESTRATEGIA 1] Primer código: ${result.isNotEmpty ? result.first.nombre : 'N/A'}');
      return result;
    } catch (e) {
      print('❌ [ESTRATEGIA 1] ===========================================');
      print('❌ [ESTRATEGIA 1] DOMINIO PERSONALIZADO FALLÓ');
      print('❌ [ESTRATEGIA 1] ===========================================');
      print('❌ [ESTRATEGIA 1] Error: $e');
      print('❌ [ESTRATEGIA 1] Tipo de error: ${e.runtimeType}');
      print('❌ [ESTRATEGIA 1] Stack trace: ${StackTrace.current}');
    }
    
    // ESTRATEGIA 2: Configurar DNS y reintentar
    try {
      print('🔧 [ESTRATEGIA 2] ===========================================');
      print('🔧 [ESTRATEGIA 2] CONFIGURANDO DNS Y REINTENTANDO');
      print('🔧 [ESTRATEGIA 2] ===========================================');
      print('🔧 [ESTRATEGIA 2] Timestamp: ${DateTime.now()}');
      print('🔧 [ESTRATEGIA 2] Llamando DnsService.autoConfigureDns()...');
      
      final dnsResult = await DnsService.autoConfigureDns();
      print('🔧 [ESTRATEGIA 2] DNS configurado: $dnsResult');
      
      print('🔧 [ESTRATEGIA 2] Reintentando con dominio personalizado...');
      final result = await CustomDomainService.getCodigos(
        categoria: categoria,
        search: search,
      );
      
      print('✅ [ESTRATEGIA 2] ÉXITO - DNS + dominio personalizado funcionó');
      print('✅ [ESTRATEGIA 2] Códigos obtenidos: ${result.length}');
      return result;
    } catch (e) {
      print('❌ [ESTRATEGIA 2] ===========================================');
      print('❌ [ESTRATEGIA 2] DNS + DOMINIO PERSONALIZADO FALLÓ');
      print('❌ [ESTRATEGIA 2] ===========================================');
      print('❌ [ESTRATEGIA 2] Error: $e');
      print('❌ [ESTRATEGIA 2] Tipo de error: ${e.runtimeType}');
    }
