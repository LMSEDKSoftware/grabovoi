        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildLegalLink('Política de Privacidad', links['privacy_policy'] ?? '#', Icons.privacy_tip),
              const SizedBox(height: 8),
              _buildLegalLink('Términos y Condiciones', links['terms'] ?? '#', Icons.description),
              const SizedBox(height: 8),
              _buildLegalLink('Política de Cookies', links['cookies'] ?? '#', Icons.cookie),
            ],
          ),
        );
      },
