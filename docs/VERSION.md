...
## v2.5.0 - Optimización KPI Panel & UI (1 Marzo 2026)

### ✅ Estado: DESPLEGADO (Edge Function) & COMMITED

### 🎯 Mejoras Implementadas

#### Panel Administrativo (KPIs):
- ✅ **Infinite Scroll (Scroll Infinito)** en el historial de uso reciente.
- ✅ **Paginación en Edge Function**: Optimización de `dashboard-stats` para carga segmentada.
- ✅ **UI Premium**: Logo oficial ManiGrab, tipografía Outfit/Inter y carga visual mejorada.
- ✅ **Visibilidad de Datos**: Se agruparon métricas de Engagement y se expandió el gráfico de categorías a dos columnas.

#### Interfaz de Usuario (App Flutter):
- ✅ **Legibilidad de Botones**: Sustitución de botones estándar por `CustomButton` en múltiples modales.
- ✅ **Visualización Garantizada**: Eliminación de elipsis en textos de botones para asegurar lectura completa.
- ✅ **Consistencia Visual**: Integración de la paleta de colores dorado/azul profundo en toda la plataforma.
