...
class _AuthWrapperState extends State<AuthWrapper> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_isAuthenticated && _needsAssessment) {
      ...
      // Siempre mostrar MainNavigation cuando está autenticado y sin evaluación pendiente
      // El tour se mostrará como overlay dentro de MainNavigation si es necesario
      print('✅ Usuario autenticado - Mostrando MainNavigation (tour: $_needsTour)');
      return MainNavigation(showTour: _needsTour);
    } else if (_forceLogin) {
