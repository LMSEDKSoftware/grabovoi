...
import 'nueva_entrada_diario_screen.dart';
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              icon: const Icon(Icons.add_circle_outline, color: Color(0xFFFFD700), size: 32),
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) => const NuevaEntradaDiarioScreen(codigo: ''),
                                  ),
                                ).then((_) => _loadDiario());
                              },
                            ),
