          ...
          if (_showTourOverlay)
            _TourOverlay(
              onFinish: () async {
                ...
                // Después del tour, llamar al callback si existe
                // Esto permitirá que AuthWrapper verifique si necesita evaluación
...
class _TourOverlayState extends State<_TourOverlay> {
  ...
  Widget _buildTourDescription(int pageIndex) {
    if (pageIndex == 0) {
      // Primera página con explicación ampliada sobre luz cuántica y cristales
      return Column(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        'Energía que acumulas con cada acción consciente. Se mide como porcentaje que crece con pilotajes, repeticiones y desafíos completados.',
                        style: GoogleFonts.lato(
                          fontSize: 13,
                          color: Colors.white70,
                          height: 1.4,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        'Recompensas que ganas al completar sesiones. Úsalos para desbloquear funciones especiales y potenciar tu experiencia.',
                        style: GoogleFonts.lato(
                          fontSize: 13,
                          color: Colors.white70,
                          height: 1.4,
